...
namespace Assets.Scripts.Systems.Drinks
{
    class DrinkMakingSystem : IEntityManager, IInitSystem
    {
        ...
        public void OnInit()
        {
            ...
            if (ui == null)
            {
                var uiResource = AssetLoader.LoadAsset(Prefabs.DrinkMixingUI);
                var uiGameObject = Object.Instantiate(uiResource);
            ...
            EventSystem.StartDrinkMakingEvent += OnOpenUI;
            EventSystem.EndDrinkMakingEvent += OnCloseUI;
        }
