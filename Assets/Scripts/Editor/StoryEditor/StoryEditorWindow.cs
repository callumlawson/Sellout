...
namespace Assets.Src.Editor.StoryEditor
{
    public class StoryEditorWindow : EditorWindow
    {
        // Information about current instance
        private static StoryEditorWindow _editor;
        public static StoryEditorWindow editor { get { AssureEditor(); return _editor; } }
...
#pragma warning restore 414
        ...
        /// </summary>
        [MenuItem("SellOut/Story Editor")]
        public static StoryEditorWindow OpenNodeEditor()
        {
            _editor = GetWindow<StoryEditorWindow>();
            ...
            _editor.titleContent = new GUIContent("Story Editor", iconTexture);
        ...
        {
            GUILayout.Label(new GUIContent("Story Editor (" + canvasCache.nodeCanvas.name + ")", "Opened Canvas path: " + canvasCache.openedCanvasPath), NodeEditorGUI.nodeLabelBold);
