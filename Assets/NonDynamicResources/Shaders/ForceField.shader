    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_2232 = (sin((5.0*((-1*(o.uv0.g*_LineDensity))+(node_1466.r*_scroll_speed))))*0.5+0.5);
                v.vertex.xyz += (node_2232*v.normal*0.1);
...
///////// Gloss:
                float node_620 = 0.0;
                float gloss = node_620;
                float perceptualRoughness = 1.0 - node_620;
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(node_2232*0.7+0.0));
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor * (node_2232*0.7+0.0),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float node_620 = 0.0;
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, node_620, specColor, specularMonochrome );
                float roughness = 1.0 - node_620;
